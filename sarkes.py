...
FISIK,Indeks Massa Tubuh,Sentral,">=25.0, LP >=80","Obesitas sentral (IMT [XX.X] kg/m2, lingkar perut [YY] cm)",Turunkan BB hingga BB ideal,"Central obesity (BMI [XX.X] kg/m2, waist circumference [YY] cm)",Reduce weight to ideal body weight
