...
FISIK,Visus,[OD; OS; ODS] Miop,Koreksi,"[OD; OS; ODS] Miopia, terkoreksi optimal dengan kacamata",Konsultasi dengan dokter spesialis mata jika ada keluhan penurunan penglihatan dengan kacamata yang sudah ada,"Myopia in [OD; OS; ODS], optimally corrected with glasses",Consult an ophthalmologist if there are complaints of decreased vision with existing glasses
...
FISIK,Visus,[OD; OS; ODS] Hiper,Koreksi,"[OD; OS; ODS] Hipermetropia, terkoreksi optimal dengan kacamata",Konsultasi dengan dokter spesialis mata jika ada keluhan penurunan penglihatan dengan kacamata yang sudah ada,"Hypermetropia in [OD; OS; ODS], optimally corrected with glasses",Consult an ophthalmologist if there are complaints of decreased vision with existing glasses
...
FISIK,Visus,[OD; OS; ODS] Pres,Koreksi,"[OD; OS; ODS] Presbiopia, terkoreksi optimal dengan kacamata",Konsultasi dengan dokter spesialis mata jika ada keluhan penurunan penglihatan dengan kacamata yang sudah ada,"Presbyopia in [OD; OS; ODS], optimally corrected with glasses",Consult an ophthalmologist if there are complaints of decreased vision with existing glasses
FISIK,Pterigium,[OD; OS; ODS] PTR,Grade 1-3,Pterigium grade [G] di [OD; OS; ODS] ,"Gunakan pelindung mata/kacamata hitam saat beraktivitas di luar ruangan untuk menghindari paparan debu, angin dan sinar matahari",Pterygium grade [G] in [OD; OS; ODS],"Use eye protection/sunglasses when outdoors to avoid exposure to dust, wind and sunlight"
...
FISIK,Telinga,Serumen [AD; AS; ADS],,Serumen di [AD; AS; ADS],Konsultasi dengan dokter spesialis THT untuk pembersihan/evakuasi serumen di [AD; AS; ADS],Cerumen in [AD; AS; ADS],Consult an ENT specialist for cerumen cleaning/evacuation in [AD; AS; ADS]
FISIK,Telinga,Prop [AD; AS; ADS],,Serumen prop di [AD; AS; ADS],Konsultasi dengan dokter spesialis THT untuk pembersihan/evakuasi serumen di [AD; AS; ADS],Cerumen prop in [AD; AS; ADS],Consult an ENT specialist for cerumen cleaning/evacuation in [AD; AS; ADS]
FISIK,Telinga,HL [AD; AS; ADS],,Kesan penurunan pendengaran di [AD; AS; ADS],Lakukan pemeriksaan audiometri dan konsultasi dengan dokter spesialis THT untuk pemeriksaan dan tata laksana lebih lanjut terkait kesan penurunan pendengaran di [AD; AS; ADS],Impression of hearing loss in [AD; AS; ADS],Perform audiometry and consult an ENT specialist for further examination and management regarding hearing loss in [AD; AS; ADS]
...
FISIK,Ekstremitas,EXT Kaki O,,Bentuk kaki O,Konsultasi dengan dokter spesialis orthopedi untuk pemeriksaan dan tata laksana lebih lanjut terkait temuan bentuk kaki O,O-shaped legs,Consult an orthopedic specialist for further examination and management of O-shaped legs
FISIK,Ekstremitas,EXT Kaki X,,Bentuk kaki X,Konsultasi dengan dokter spesialis orthopedi untuk pemeriksaan dan tata laksana lebih lanjut terkait temuan bentuk kaki X,X-shaped legs,Consult an orthopedic specialist for further examination and management of X-shaped legs
