...
FISIK,Mammae,MM [D; S; DS],,Benjolan di [D; S; DS],Konsultasi dengan dokter spesialis bedah onkologi untuk pemeriksaan dan tata laksana lebih lanjut terkait temuan benjolan di [D; S; DS],Lump in [D; S; DS] breast,Consult a surgical oncologist for further evaluation and management of [D; S; DS] breast lump findings
