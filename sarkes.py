...
# ==========================================
# 2. DATABASE BILINGUAL (DIPERBARUI)
# ==========================================
# Menambahkan kolom: KESIMPULAN (English) dan SARAN KHUSUS (English)
...
FISIK,Tekanan Darah,PreHT,120-139/80-89,Prehipertensi (tekanan darah [XXX/XX] mmHg),Monitor tekanan darah secara berkala,Prehypertension (blood pressure [XXX/XX] mmHg),Monitor blood pressure regularly
FISIK,Tekanan Darah,HT1,140-159/90-100,Hipertensi stage 1 (tekanan darah [XXX/XX] mmHg),Minum obat antihipertensi dan monitor tekanan darah secara berkala,Stage 1 Hypertension (blood pressure [XXX/XX] mmHg),Take antihypertensive medication and monitor blood pressure regularly
FISIK,Tekanan Darah,HT2,>=160/>=100,Hipertensi stage 2 (tekanan darah [XXX/XXX] mmHg),Minum obat antihipertensi dan monitor tekanan darah secara berkala,Stage 2 Hypertension (blood pressure [XXX/XXX] mmHg),Take antihypertensive medication and monitor blood pressure regularly
FISIK,Tekanan Darah,RHT TK,>=140/>=90,Riwayat hipertensi tidak terkontrol (tekanan darah saat ini [XXX/XX] mmHg),Minum obat antihipertensi dan monitor tekanan darah secara berkala,Uncontrolled history of hypertension (current blood pressure [XXX/XX] mmHg),Take antihypertensive medication and monitor blood pressure regularly
FISIK,Tekanan Darah,RHT Kontrol,<=140/<=90,Riwayat hipertensi terkontrol (tekanan darah saat ini [XXX/XX] mmHg),Minum obat antihipertensi dan monitor tekanan darah secara berkala,Controlled history of hypertension (current blood pressure [XXX/XX] mmHg),Take antihypertensive medication and monitor blood pressure regularly
...
FISIK,Visus,[OD; OS; ODS] Hiper,TKM,"[OD; OS; ODS] Hipermetropia, tanpa kacamata",Konsultasi dengan dokter spesialis mata untuk koreksi visus mata dengan kacamata yang sesuai,"Hypermetropia on [OD; OS; ODS], without glasses",Consult an ophthalmologist for visual acuity correction with appropriate glasses
FISIK,Visus,[OD; OS; ODS] Hiper,DKM,"[OD; OS; ODS] Hipermetropia, belum terkoreksi optimal dengan kacamata",Konsultasi dengan dokter spesialis mata untuk koreksi visus mata dengan kacamata yang sesuai,"Hypermetropia on [OD; OS; ODS], not optimally corrected with glasses",Consult an ophthalmologist for visual acuity correction with appropriate glasses
FISIK,Visus,[OD; OS; ODS] Hiper,Koreksi,"[OD; OS; ODS] Hipermetropia, terkoreksi optimal dengan kacamata",Konsultasi dengan dokter spesialis mata jika ada keluhan penurunan penglihatan dengan kacamata yang sudah ada,"Hypermetropia on [OD; OS; ODS], optimally corrected with glasses",Consult an ophthalmologist if there are complaints of decreased vision with existing glasses
FISIK,Visus,[OD; OS; ODS] Pres,TKM,"[OD; OS; ODS] Presbiopia, tanpa kacamata",Konsultasi dengan dokter spesialis mata untuk koreksi visus mata dengan kacamata yang sesuai,"Presbyopia on [OD; OS; ODS], without glasses",Consult an ophthalmologist for visual acuity correction with appropriate glasses
FISIK,Visus,[OD; OS; ODS] Pres,DKM,"[OD; OS; ODS] Presbiopia, belum terkoreksi optimal dengan kacamata",Konsultasi dengan dokter spesialis mata untuk koreksi visus mata dengan kacamata yang sesuai,"Presbyopia on [OD; OS; ODS], not optimally corrected with glasses",Consult an ophthalmologist for visual acuity correction with appropriate glasses
FISIK,Visus,[OD; OS; ODS] Pres,Koreksi,"[OD; OS; ODS] Presbiopia, terkoreksi optimal dengan kacamata",Konsultasi dengan dokter spesialis mata jika ada keluhan penurunan penglihatan dengan kacamata yang sudah ada,"Presbyopia on [OD; OS; ODS], optimally corrected with glasses",Consult an ophthalmologist if there are complaints of decreased vision with existing glasses
FISIK,Pterigium,[OD; OS; ODS] PTR,Grade 1-3,Pterigium grade [G] di [OD; OS; ODS] ,"Gunakan pelindung mata/kacamata hitam saat beraktivitas di luar ruangan untuk menghindari paparan debu, angin dan sinar matahari",Pterygium grade [G] on [OD; OS; ODS],"Use eye protection/sunglasses when outdoors to avoid exposure to dust, wind and sunlight"
FISIK,Buta Warna,BW,Parsial,Buta warna parsial,Dapat ditempatkan pada pekerjaan yang tidak membutuhkan ketelitian warna,Partial color blindness,Can be placed in jobs that do not require color precision
FISIK,Telinga,Serumen [AD; AS; ADS],,Serumen di [AD; AS; ADS],Konsultasi dengan dokter spesialis THT untuk pembersihan/evakuasi serumen di [AD; AS; ADS],Cerumen on [AD; AS; ADS],Consult an ENT specialist for cerumen cleaning/evacuation on [AD; AS; ADS]
FISIK,Telinga,Prop [AD; AS; ADS],,Serumen prop di [AD; AS; ADS],Konsultasi dengan dokter spesialis THT untuk pembersihan/evakuasi serumen di [AD; AS; ADS],Cerumen prop on [AD; AS; ADS],Consult an ENT specialist for cerumen cleaning/evacuation on [AD; AS; ADS]
FISIK,Telinga,HL [AD; AS; ADS],,Kesan penurunan pendengaran di [AD; AS; ADS],Lakukan pemeriksaan audiometri dan konsultasi dengan dokter spesialis THT untuk pemeriksaan dan tata laksana lebih lanjut terkait kesan penurunan pendengaran di [AD; AS; ADS],Impression of hearing loss on [AD; AS; ADS],Perform audiometry and consult an ENT specialist for further examination and management regarding hearing loss on [AD; AS; ADS]
FISIK,Tonsil,Tonsil,Ukuran T2/T2; T3/T3; T4/T4,Hipertrofi tonsil [TT/TT],Konsultasi dengan dokter spesialis THT untuk pemeriksaan dan tata laksana lebih lanjut terkait pembesaran/hipertrofi tonsil,Tonsillar hypertrophy [TT/TT],Consult an ENT specialist for further examination and management of tonsillar hypertrophy
FISIK,Faring,Faring,Hiperemis,Faring hiperemis,Konsultasi dengan dokter spesialis THT untuk pemeriksaan dan tata laksana lebih lanjut terkait temuan faringitis,Pharyngeal hyperemia,Consult an ENT specialist for further examination and management of pharyngitis findings
FISIK,Mammae,MM [D; S; DS],,Benjolan di payudara [D; S; DS],Konsultasi dengan dokter spesialis bedah onkologi untuk pemeriksaan dan tata laksana lebih lanjut terkait temuan benjolan di payudara [D; S; DS],Lump in [D; S; DS] breast,Consult a surgical oncologist for further examination and management of breast lump findings in [D; S; DS] breast
...
FISIK,Thoraks,Paru,Wheezing,Terdapat wheezing pada paru,Konsultasi dengan dokter spesialis paru untuk pemeriksaan dan tata laksana lebih lanjut terkait temuan paru abnormal,Wheezing in lungs,Consult a pulmonologist for further examination and management of abnormal lung findings
FISIK,Abdomen,NT,Epi,Nyeri tekan epigastrium,Konsultasi dengan dokter spesialis penyakit dalam untuk pemeriksaan dan tata laksana lebih lanjut terkait nyeri tekan epigastrium,Epigastric tenderness,Consult an internist for further examination and management of epigastric tenderness
FISIK,Abdomen,Ketok [D; S; DS],,Nyeri ketok ginjal [D; S; DS],Konsultasi dengan dokter spesialis penyakit dalam untuk pemeriksaan dan tata laksana lebih lanjut terkait nyeri ketok ginjal [D; S; DS],CVA tenderness [D; S; DS],Consult an internist for further examination and management of CVA tenderness [D; S; DS]
FISIK,Genital perianal,HI,Grade 1-4,Hemorrhoid interna grade [G],"Tingkatkan asupan serat (sayur dan buah), minum air putih minimal 2L/hari dan hindari aktivitas duduk terlalu lama - Konsultasi dengan dokter spesialis bedah untuk pemeriksaan dan tata laksana lebih lanjut terkait temuan hemorroid interna",Internal hemorrhoid grade [G],"Increase fiber intake (vegetables and fruits), drink at least 2L of water/day and avoid prolonged sitting - Consult a surgeon for further examination and management of internal hemorrhoids"
FISIK,Genital perianal,HE,Eksterna,Hemorrhoid eksterna,"Tingkatkan asupan serat (sayur dan buah), minum air putih minimal 2L/hari dan hindari aktivitas duduk terlalu lama - Konsultasi dengan dokter spesialis bedah untuk pemeriksaan dan tata laksana lebih lanjut terkait temuan hemorroid eksterna",External hemorrhoid,"Increase fiber intake (vegetables and fruits), drink at least 2L of water/day and avoid prolonged sitting - Consult a surgeon for further examination and management of external hemorrhoids"
FISIK,Ekstremitas,EXT Kaki O,Kaki O,Bentuk kaki O,Konsultasi dengan dokter spesialis orthopedi untuk pemeriksaan dan tata laksana lebih lanjut terkait temuan bentuk kaki O,O-shaped legs,Consult an orthopedic specialist for further examination and management of O-shaped legs
FISIK,Ekstremitas,EXT Kaki X,Kaki X,Bentuk kaki X,Konsultasi dengan dokter spesialis orthopedi untuk pemeriksaan dan tata laksana lebih lanjut terkait temuan bentuk kaki X,X-shaped legs,Consult an orthopedic specialist for further examination and management of X-shaped legs
FISIK,Gigi,Gigi,Jumlah 1-32,"Gigi: Gigi Hilang ([X]), Sisa Akar ([R]), Abrasi ([A]), Karies ([C]), Karang Gigi ([E]), Perawatan Saluran Akar ([M]), Tumpatan ([F]), Impaksi ([I]), Gigi Palsu ([P]), Gigi Patah ([FR])",Konsultasi dengan dokter gigi untuk perawatan gigi,"Teeth: Missing teeth ([X]), Radix ([R]), Abrasion ([A]), Caries ([C]), Calculus ([E]), Root canal treatment ([M]), Filling ([F]), Impaction ([I]), Denture ([P]), Fractured tooth ([FR])",Consult a dentist for dental treatment
LAB,Hematologi,Poli,HB >16.0,Suspek polisithemia (Hemoglobin [XX.X] g/dL),Konsultasi dengan dokter spesialis penyakit dalam untuk pemeriksaan dan tata laksana lebih lanjut terkait suspek polisitemia,Suspect polycythemia (Hemoglobin [XX.X] g/dL),Consult an internist for further examination and management of suspected polycythemia
LAB,Hematologi,ANN,HB  <12.0,Anemia normositik normokromik (Hemoglobin [XX.X] g/dL),"Tingkatkan asupan makanan yang mengandung zat besi (sayuran hijau, daging merah, hati), hindari teh dan kopi - Konsultasi dengan dokter spesialis penyakit dalam untuk pemeriksaan dan tata laksana lebih lanjut terkait anemia",Normocytic normochromic anemia (Hemoglobin [XX.X] g/dL),"Increase intake of iron-rich foods (green vegetables, red meat, liver), avoid tea and coffee - Consult an internist for further examination and management of anemia"
LAB,Hematologi,ANM,"HB <12.0, MCV <=80.0,  MCH <=26.0","Anemia mikrositik hipokromik (Hemoglobin [XX.X] g/dL, MCV [YY.Y] fL, MCH [ZZ.Z] pg)","Tingkatkan asupan makanan yang mengandung zat besi (sayuran hijau, daging merah, hati), hindari teh dan kopi - Konsultasi dengan dokter spesialis penyakit dalam untuk pemeriksaan dan tata laksana lebih lanjut terkait anemia","Microcytic hypochromic anemia (Hemoglobin [XX.X] g/dL, MCV [YY.Y] fL, MCH [ZZ.Z] pg)","Increase intake of iron-rich foods (green vegetables, red meat, liver), avoid tea and coffee - Consult an internist for further examination and management of anemia"
LAB,Hematologi,Eritro,>5.0,Eritrositosis [X.X] x 10^6/uL,Konsultasi dengan dokter spesialis penyakit dalam untuk pemeriksaan dan tata laksana lebih lanjut terkait eritrositosis,Erythrocytosis [X.X] x 10^6/uL,Consult an internist for further examination and management of erythrocytosis
LAB,Hematologi,LKS,>=12.0,Leukositosis [XX.X] x 10^3/uL --> suspek infeksi bakteri,Konsultasi dengan dokter spesialis penyakit dalam untuk pemeriksaan dan tata laksana lebih lanjut terkait leukositosis,Leukocytosis [XX.X] x 10^3/uL --> suspect bacterial infection,Consult an internist for further examination and management of leukocytosis
LAB,Hematologi,LKT,10.0-11.9,Peningkatan leukosit [XX.X] x 10^3/uL,Konsultasi dengan dokter spesialis penyakit dalam untuk pemeriksaan dan tata laksana lebih lanjut terkait peningkatan leukosit,Increased leukocytes [XX.X] x 10^3/uL,Consult an internist for further examination and management of increased leukocytes
LAB,Hematologi,LKP,<4.0,Leukopenia [X.X] x 10^3/uL,Konsultasi dengan dokter spesialis penyakit dalam untuk pemeriksaan dan tata laksana lebih lanjut terkait leukopenia,Leukopenia [X.X] x 10^3/uL,Consult an internist for further examination and management of leukopenia
LAB,Hematologi,Eos,>4.0,Eosinofilia [X.X] %,Hindari faktor pencetus alergi,Eosinophilia [X.X] %,Avoid allergy triggers
...
LAB,Hematologi,Fraksi HB,,Ditemukan fraksi hemoglobin varian,Lakukan pemeriksaan analisa hemoglobin,Found hemoglobin variant fraction,Perform hemoglobin analysis
LAB,Hematologi,PLT,>=450,Trombositosis [XXX] x 10^3/uL,Konsultasi dengan dokter spesialis penyakit dalam untuk pemeriksaan dan tata laksana lebih lanjut terkait trombositosis,Thrombocytosis [XXX] x 10^3/uL,Consult an internist for further examination and management of thrombocytosis
LAB,Glukosa,GDP,100-125,"Hiperglikemia, glukosa puasa [XXX] mg/dL --> suspek prediabetes","Turunkan kadar glukosa darah dan lakukan pemeriksaan HbA1c secara berkala setiap 3 bulan - Diet rendah gula dan karbohidrat","Hyperglycemia, fasting glucose [XXX] mg/dL --> suspect prediabetes","Reduce blood glucose levels and perform HbA1c checks regularly every 3 months - Low sugar and carbohydrate diet"
LAB,Glukosa,GDP,>=126,"Hiperglikemia, glukosa puasa [XXX] mg/dL --> suspek Diabetes Mellitus","Turunkan kadar glukosa darah dan lakukan pemeriksaan HbA1c secara berkala setiap 3 bulan - Diet rendah gula dan karbohidrat","Hyperglycemia, fasting glucose [XXX] mg/dL --> suspect Diabetes Mellitus","Reduce blood glucose levels and perform HbA1c checks regularly every 3 months - Low sugar and carbohydrate diet"
LAB,Glukosa,GDP,>=130 (RDM),Riwayat Diabetes Mellitus tidak terkontrol (Glukosa puasa saat ini [XXX] mg/dL),"Minum obat antidiabetes secara rutin, monitor kadar glukosa darah dan lakukan pemeriksaan HbA1c secara berkala setiap 3 bulan - Diet rendah gula dan karbohidrat",Uncontrolled history of Diabetes Mellitus (Current fasting glucose [XXX] mg/dL),"Take antidiabetic medication regularly, monitor blood glucose levels and perform HbA1c checks regularly every 3 months - Low sugar and carbohydrate diet"
LAB,Glukosa,GDP,<130 (RDM),Riwayat Diabetes Mellitus terkontrol (Glukosa puasa saat ini [XXX] mg/dL),"Minum obat antidiabetes secara rutin, monitor kadar glukosa darah dan lakukan pemeriksaan HbA1c secara berkala setiap 3 bulan - Diet rendah gula dan karbohidrat",Controlled history of Diabetes Mellitus (Current fasting glucose [XXX] mg/dL),"Take antidiabetic medication regularly, monitor blood glucose levels and perform HbA1c checks regularly every 3 months - Low sugar and carbohydrate diet"
LAB,Glukosa,HbA1c,5.7-6.4,Peningkatan HbA1c [X.X] % --> suspek prediabetes,"Turunkan kadar glukosa darah dan lakukan pemeriksaan HbA1c secara berkala setiap 3 bulan - Diet rendah gula dan karbohidrat",Increased HbA1c [X.X] % --> suspect prediabetes,"Reduce blood glucose levels and perform HbA1c checks regularly every 3 months - Low sugar and carbohydrate diet"
LAB,Glukosa,HbA1c,>=6.5,Peningkatan HbA1c [X.X] % --> suspek Diabetes Mellitus,"Turunkan kadar glukosa darah dan lakukan pemeriksaan HbA1c secara berkala setiap 3 bulan - Diet rendah gula dan karbohidrat",Increased HbA1c [X.X] % --> suspect Diabetes Mellitus,"Reduce blood glucose levels and perform HbA1c checks regularly every 3 months - Low sugar and carbohydrate diet"
LAB,Glukosa,HbA1c,>=7.0 (RDM),Riwayat Diabetes Mellitus tidak terkontrol (HbA1c saat ini [X.X] %),"Minum obat antidiabetes secara rutin, monitor kadar glukosa darah dan lakukan pemeriksaan HbA1c secara berkala setiap 3 bulan - Diet rendah gula dan karbohidrat",Uncontrolled history of Diabetes Mellitus (Current HbA1c [X.X] %),"Take antidiabetic medication regularly, monitor blood glucose levels and perform HbA1c checks regularly every 3 months - Low sugar and carbohydrate diet"
LAB,Glukosa,HbA1c,<7.0 (RDM),Riwayat Diabetes Mellitus terkontrol (HbA1c saat ini [X.X] %),"Minum obat antidiabetes secara rutin, monitor kadar glukosa darah dan lakukan pemeriksaan HbA1c secara berkala setiap 3 bulan - Diet rendah gula dan karbohidrat",Controlled history of Diabetes Mellitus (Current HbA1c [X.X] %),"Take antidiabetic medication regularly, monitor blood glucose levels and perform HbA1c checks regularly every 3 months - Low sugar and carbohydrate diet"
LAB,Lipid Profile,TC,200-239,Kolesterol total dalam batas tinggi [XXX] mg/dL,Diet rendah lemak,Total cholesterol borderline high [XXX] mg/dL,Low fat diet
...
LAB,Lipid Profile,LDL,100-129,Kolesterol LDL Direk mendekati optimal [XXX] mg/dL,Diet rendah lemak,LDL Direct cholesterol near optimal [XXX] mg/dL,Low fat diet
LAB,Lipid Profile,LDL,130-159,Kolesterol LDL Direk dalam batas tinggi [XXX] mg/dL,Diet rendah lemak,LDL Direct cholesterol borderline high [XXX] mg/dL,Low fat diet
LAB,Lipid Profile,LDL,160-189,Kolesterol LDL Direk tinggi [XXX] mg/dL,Diet rendah lemak,High LDL Direct cholesterol [XXX] mg/dL,Low fat diet
LAB,Lipid Profile,LDL,>=190,Kolesterol LDL Direk sangat tinggi [XXX] mg/dL,Diet rendah lemak,Very high LDL Direct cholesterol [XXX] mg/dL,Low fat diet
LAB,Lipid Profile,HDL,<40,Kolesterol HDL rendah [XX] mg/dL,Diet rendah lemak,Low HDL cholesterol [XX] mg/dL,Low fat diet
LAB,Lipid Profile,TG,150-199,Trigliserida dalam batas tinggi [XXX] mg/dL,Diet rendah lemak dan karbohidrat,Triglycerides borderline high [XXX] mg/dL,Low fat and carbohydrate diet
...
LAB,Faal Ginjal,Kreat,>0.90,Peningkatan kreatinin [X.XX] mg/dL,Konsultasi dengan dokter spesialis penyakit dalam untuk pemeriksaan dan tata laksana lebih lanjut terkait peningkatan kreatinin,Increased creatinine [X.XX] mg/dL,Consult an internist for further examination and management of increased creatinine
LAB,Faal Ginjal,GGJ,>0.90 (eLFG >=60),"Suspek gangguan fungsi ginjal (Kreatinin [X.XX] mg/dL, eLFG [YY] mL/menit/1.73 m2)",Konsultasi dengan dokter spesialis penyakit dalam untuk pemeriksaan dan tata laksana lebih lanjut terkait suspek gangguan fungsi ginjal,"Suspected renal function impairment (Creatinine [X.XX] mg/dL, eGFR [YY] mL/min/1.73 m2)",Consult an internist for further examination and management of suspected renal function impairment
LAB,Faal Ginjal,FGJ,>0.90 (eLFG <60),"Suspek penurunan fungsi ginjal (Kreatinin [X.XX] mg/dL, eLFG [YY] mL/menit/1.73 m2)",Konsultasi dengan dokter spesialis penyakit dalam untuk pemeriksaan dan tata laksana lebih lanjut terkait suspek penurunan fungsi ginjal,"Suspected decreased renal function (Creatinine [X.XX] mg/dL, eGFR [YY] mL/min/1.73 m2)",Consult an internist for further examination and management of suspected decreased renal function
LAB,Faal hati,Hati GOT,>=27,Peningkatan enzim hati (GOT [XX] U/L),Konsultasi dengan dokter spesialis penyakit dalam untuk pemeriksaan dan tata laksana lebih lanjut terkait peningkatan enzim hati,Increased liver enzymes (GOT [XX] U/L),Consult an internist for further examination and management of increased liver enzymes
LAB,Faal hati,Hati GPT,>=34,Peningkatan enzim hati (GPT [XX] U/L),Konsultasi dengan dokter spesialis penyakit dalam untuk pemeriksaan dan tata laksana lebih lanjut terkait peningkatan enzim hati,Increased liver enzymes (GPT [XX] U/L),Consult an internist for further examination and management of increased liver enzymes
LAB,Faal hati,Hati ALL,GOT >=27 & GPT >=34,"Peningkatan enzim hati (GOT [XX] U/L, GPT [YY] U/L)",Konsultasi dengan dokter spesialis penyakit dalam untuk pemeriksaan dan tata laksana lebih lanjut terkait peningkatan enzim hati,"Increased liver enzymes (GOT [XX] U/L, GPT [YY] U/L)",Consult an internist for further examination and management of increased liver enzymes
LAB,Faal hati,GGH GOT,>=54,Suspek gangguan fungsi hati (GOT [XX] U/L),Konsultasi dengan dokter spesialis penyakit dalam untuk pemeriksaan dan tata laksana lebih lanjut terkait suspek gangguan fungsi hati,Suspected liver function impairment (GOT [XX] U/L),Consult an internist for further examination and management of suspected liver function impairment
LAB,Faal hati,GGH GPT,>=68,Suspek gangguan fungsi hati (GOT [XX] U/L),Konsultasi dengan dokter spesialis penyakit dalam untuk pemeriksaan dan tata laksana lebih lanjut terkait suspek gangguan fungsi hati,Suspected liver function impairment (GOT [XX] U/L),Consult an internist for further examination and management of suspected liver function impairment
LAB,Faal hati,GGH ALL,GOT >=54 & GPT>=68,"Suspek gangguan fungsi hati (GOT [XX] U/L, GPT [YY] U/L)",Konsultasi dengan dokter spesialis penyakit dalam untuk pemeriksaan dan tata laksana lebih lanjut terkait suspek gangguan fungsi hati,"Suspected liver function impairment (GOT [XX] U/L, GPT [YY] U/L)",Consult an internist for further examination and management of suspected liver function impairment
LAB,Faal hati,HBsAg,Reaktif,HBsAg Reaktif,"Konsultasi dengan dokter spesialis penyakit dalam untuk pemeriksaan dan tata laksana lebih lanjut terkait temuan HBsAg reaktif - Lakukan pemeriksaan imunologi/serologi untuk menentukan status infeksi Hepatitis B",HBsAg Reactive,"Consult an internist for further examination and management of reactive HBsAg findings - Perform immunology/serology tests to determine Hepatitis B infection status"
...
LAB,Faal hati,AntiHBs,Reaktif,Sudah terbentuk antibodi/kekebalan terhadap virus Hepatitis B,,Antibodies/immunity to Hepatitis B virus have formed,
...
LAB,Urinalisa,Alb,[text_input],Albuminuria [text_input] mg/dL,Konsultasi dengan dokter spesialis urologi untuk pemeriksaan dan tata laksana lebih lanjut terkait hasil urinalisa abnormal,Albuminuria [text_input] mg/dL,Consult a urologist for further examination and management of abnormal urinalysis results
LAB,Urinalisa,keton,[text_input],Ketonuria [text_input] mg/dL,Konsultasi dengan dokter spesialis urologi untuk pemeriksaan dan tata laksana lebih lanjut terkait hasil urinalisa abnormal,Ketonuria [text_input] mg/dL,Consult a urologist for further examination and management of abnormal urinalysis results
LAB,Urinalisa,LE,[text_input],"Leukosituria [text_input]/uL, sedimen leukosit [text_input]/LPB",Konsultasi dengan dokter spesialis urologi untuk pemeriksaan dan tata laksana lebih lanjut terkait hasil urinalisa abnormal,"Leukocyturia [text_input]/uL, leukocyte sediment [text_input]/HPF",Consult a urologist for further examination and management of abnormal urinalysis results
LAB,Urinalisa,Glukosuria,[text_input],Glukosuria [text_input] mg/dL,Konsultasi dengan dokter spesialis urologi untuk pemeriksaan dan tata laksana lebih lanjut terkait hasil urinalisa abnormal,Glucosuria [text_input] mg/dL,Consult a urologist for further examination and management of abnormal urinalysis results
LAB,Urinalisa,hema,[text_input],"Hematuria [text_input]/uL, sedimen eritrosit [text_input]/LPB",Konsultasi dengan dokter spesialis urologi untuk pemeriksaan dan tata laksana lebih lanjut terkait hasil urinalisa abnormal,"Hematuria [text_input]/uL, erythrocyte sediment [text_input]/HPF",Consult a urologist for further examination and management of abnormal urinalysis results
...
LAB,Urinalisa,Bakteri,,Bakteriuria (+)/LPB,Hindari kebiasaan menahan BAK dan jaga higienitas area genitalia,Bacteriuria (+)/HPF,Avoid holding urine and maintain genital hygiene
LAB,Feses,FS Parasit,Parasit,Ditemukan parasit blastocystis hominis (+) pada feses,Konsultasi dengan dokter spesialis penyakit dalam untuk pemeriksaan dan tata laksana lebih lanjut terkait hasil analisa feses abnormal,Parasite blastocystis hominis (+) found in feces,Consult an internist for further examination and management of abnormal fecal analysis results
LAB,Feses,FS Leuko,Leuko,Ditemukan leukosit 0-1/LPB pada feses,Konsultasi dengan dokter spesialis penyakit dalam untuk pemeriksaan dan tata laksana lebih lanjut terkait hasil analisa feses abnormal,Leukocytes 0-1/HPF found in feces,Consult an internist for further examination and management of abnormal fecal analysis results
LAB,Feses,FS Eri,Eri,Ditemukan eritrosit 0-1/LPB pada feses,Konsultasi dengan dokter spesialis penyakit dalam untuk pemeriksaan dan tata laksana lebih lanjut terkait hasil analisa feses abnormal,Erythrocytes 0-1/HPF found in feces,Consult an internist for further examination and management of abnormal fecal analysis results
RONTGEN ,Thorax,Ro,Bronchitis,Rontgen Thorax: Bronchitis,Konsultasi dengan dokter spesialis paru untuk pemeriksaan dan tata laksana lebih lanjut terkait temuan rontgen thorax abnormal,Chest X-ray: Bronchitis,Consult a pulmonologist for further examination and management of abnormal chest X-ray findings
RONTGEN ,Thorax,Ro,Cardiomegali,Rontgen Thorax: Cardiomegali,Konsultasi dengan dokter spesialis jantung untuk pemeriksaan dan tata laksana lebih lanjut terkait temuan rontgen thorax abnormal,Chest X-ray: Cardiomegaly,Consult a cardiologist for further examination and management of abnormal chest X-ray findings
RONTGEN ,Thorax,Ro,Scoliosis,Rontgen Thorax: Dextroscoliosis thoracalis,Konsultasi dengan dokter spesialis orthopedi untuk pemeriksaan dan tata laksana lebih lanjut terkait temuan rontgen thorax abnormal,Chest X-ray: Dextroscoliosis thoracalis,Consult an orthopedic specialist for further examination and management of abnormal chest X-ray findings
AUDIOMETRI,Audiometri,Audio [AD; AS; ADS],[text_input],Audiometri [AD; AS; ADS]: [text_input],"Evaluasi faktor risiko dan etiologi terkait hasil audiometri [AD; AS; ADS] abnormal - Konsul dokter spesialis THT untuk pemeriksaan dan tatalaksana lebih lanjut terkait hasil audiometri [AD; AS; ADS] abnormal",Audiometry [AD; AS; ADS]: [text_input],"Evaluate risk factors and etiology regarding abnormal audiometry results on [AD; AS; ADS] - Consult an ENT specialist for further examination and management of abnormal audiometry results on [AD; AS; ADS]"
...
TREADMILL,Treadmill,TMT,Iskemik,Treadmill test: Respon ischemic positive,Konsultasi dengan dokter spesialis jantung untuk pemeriksaan dan tatalaksana lebih lanjut terkait hasil Treadmill Test abnormal,Treadmill test: Ischemic positive response,Consult a cardiologist for further examination and management of abnormal Treadmill Test results
USG,USG Abdomen,USG Abd,[text_input],USG Whole Abdomen: [text_input],Konsultasi dengan dokter spesialis penyakit dalam untuk pemeriksaan dan tata laksana lebih lanjut terkait hasil USG Abdomen abnormal,USG Whole Abdomen: [text_input],Consult an internist for further examination and management of abnormal Abdominal USG results
USG,USG Mammae,USG MM,[text_input],USG Mammae: [text_input],Konsultasi dengan dokter spesialis bedah onkologi untuk pemeriksaan dan tata laksana lebih lanjut terkait hasil USG Mammae abnormal,USG Mammae: [text_input],Consult a surgical oncologist for further examination and management of abnormal Mammary USG results
SSBC,SSBC,SSBC,[text_input],SSBC: [text_input],Konsultasi dengan dokter spesialis obsgyn untuk pemeriksaan dan tata laksana lebih lanjut terkait hasil SSBC abnormal,SSBC: [text_input],Consult an Ob-Gyn specialist for further examination and management of abnormal SSBC results
...
def replace_placeholders(text, row_input, matched_code_variant, lang='id'):
    ...
    if "astig" in row_input.lower():
        if lang == 'en':
             processed_text = re.sub(r"\b(Myopia|Hypermetropia|Presbyopia)\b", r"\1 Astigmatism", processed_text, flags=re.IGNORECASE)
        else:
