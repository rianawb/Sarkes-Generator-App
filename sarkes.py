...
LAB,Faal Ginjal,Kreat,>0.90,Peningkatan kreatinin [X.XX] mg/dL,Konsultasi dengan dokter spesialis penyakit dalam untuk pemeriksaan dan tata laksana lebih lanjut terkait peningkatan kreatinin,Increased creatinine [X.XX] mg/dL,Consult an internist for further evaluation and management of increased creatinine
...
LAB,Faal hati,Hati GOT,>=27,Peningkatan enzim hati (GOT [XX] U/L),Konsultasi dengan dokter spesialis penyakit dalam untuk pemeriksaan dan tata laksana lebih lanjut terkait peningkatan enzim hati,Increased liver enzymes (GOT [XX] U/L),Consult an internist for further evaluation and management of increased liver enzymes
LAB,Faal hati,Hati GPT,>=34,Peningkatan enzim hati (GPT [XX] U/L),Konsultasi dengan dokter spesialis penyakit dalam untuk pemeriksaan dan tata laksana lebih lanjut terkait peningkatan enzim hati,Increased liver enzymes (GPT [XX] U/L),Consult an internist for further evaluation and management of increased liver enzymes
LAB,Faal hati,Hati ALL,GOT >=27 & GPT >=34,"Peningkatan enzim hati (GOT [XX] U/L, GPT [YY] U/L)",Konsultasi dengan dokter spesialis penyakit dalam untuk pemeriksaan dan tata laksana lebih lanjut terkait peningkatan enzim hati,"Increased liver enzymes (GOT [XX] U/L, GPT [YY] U/L)",Consult an internist for further evaluation and management of increased liver enzymes
...
LAB,Faal hati,GGH GPT,>=68,Suspek gangguan fungsi hati (GOT [XX] U/L),Konsultasi dengan dokter spesialis penyakit dalam untuk pemeriksaan dan tata laksana lebih lanjut terkait suspek gangguan fungsi hati,Suspected liver function impairment (GOT [XX] U/L),Consult an internist for further evaluation and management of suspected liver function impairment
...
LAB,Feses,FS Parasit,Parasit,Ditemukan parasit blastocystis hominis (+) pada feses,Konsultasi dengan dokter spesialis penyakit dalam untuk pemeriksaan dan tata laksana lebih lanjut terkait hasil analisa feses abnormal,Parasite blastocystis hominis (+) found in feces,Consult an internist for further evaluation and management of abnormal fecal analysis results
...
USG,USG Mammae,USG MM,[text_input],USG Mammae: [text_input],Konsultasi dengan dokter spesialis bedah onkologi untuk pemeriksaan dan tata laksana lebih lanjut terkait hasil USG Mammae abnormal,USG Mammae: [text_input],Consult a surgical oncologist for further evaluation and management of abnormal Mammary USG results
SSBC,SSBC,SSBC,[text_input],SSBC: [text_input],Konsultasi dengan dokter spesialis obsgyn untuk pemeriksaan dan tata laksana lebih lanjut terkait hasil SSBC abnormal,SSBC: [text_input],Consult an Ob-Gyn specialist for further evaluation and management of abnormal SSBC results
